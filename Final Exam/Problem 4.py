...
#    If L = [10, 4, 3, 8, 3, 4, 5, 7, 7, 2] then the longest run of monotonically increasing numbers in L is [3, 4, 5, 7, 7] and
#    the longest run of monotonically decreasing numbers in L is [10, 4, 3].
#    Your function should return the value 26 because the longest run of monotonically increasing integers is longer than the longest run
...
#    monotonically decreasing numbers in L is [5, 4].
